    ...
    <div class="col-md-12">
        <div class="expend cat-widget">
            <div class="widget-title">
                <h4><a href="">EXPEND</a></h4>
                <span class="sub-title">รายรับ-รายจ่าย</span>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo Html::submitButton('ค้นหา', ['class' => 'btn btn-default', /*'onclick' => 'confirmOdds('.json_encode($_POST).')'*/]); ?>
                                </div>
                            </div>
                        </div>
                        <?php ActiveForm::end(); ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            ...
                            <?= Html::a('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> จัดการข้อมูล', ['/expend/manage'], ['class' => 'btn btn-info']) ?>
                        </p>
