                                    ...
                                    <div class="image-gallery-wrapper gallery-main">
                                        ...
                                        <div class="label">
                                            <div class="label-text">
                                                <a href="/gallery/manage?album=<?= $row->ref ?>" class="text-title"><?= $row->name ?></a>
                                        ...
                                        <div class="label-action">
                                            <div class="btn-action">
                                                ...
                                                <a href="/gallery/manage?album=<?= $row->ref ?>" class="pull-left" title="แก้ไข"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
