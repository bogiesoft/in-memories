    ...
    <div class="col-md-4">
        ...
        <section id="game-rule">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <p>กฎกติกาและวิธีการเล่นเกม</p>
                </div>
                <div class="content">
                    <!--<span>1. 1 IP ท่านสามารถเล่นได้ 3 accountเท่านั้น หากพบมากกว่านั้นจะทำการตัดสิทธิ์ทันที</span><br />
                    <span>2. ท่านสามารถเล่นได้ 2 ครั้งใน 1 วัน</span><br />
                    <span>3. สเต็ป 1 ใบ สามารถเล่นได้อย่างต่ำ 3 คู่ แต่ไม่เกิน 10 คู่</span><br />
                    <span>4. แทงขั้นต่ำ 50 zeny แต่ไม่เกิน 10,000 zeny</span><br />
                    <span>5. การคิดเงินจะคูณตามอัตราของทีมที่ชนะ</span><br />
                    <span>6. ได้ครึ่ง / เสียครึ่ง คิด 1.4 ทุกกรณี</span><br />
                    <span>7. คู่ไหนมีปัญหา ยกเลิกเฉพาะคู่นั้น</span><br />-->
                    <!--<span>8. ได้ครึ่ง / เสียครึ่ง คิด 1.4 ทุกกรณี</span><br />-->
                    <ul>
