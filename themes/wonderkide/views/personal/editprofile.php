        ...
        <section id="show-profile" class="profile-detail">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?= Html::button('แก้ไขข้อมูล', ['class' => 'btn btn-warning btn-sm pull-right']) ?>
                </div>
            </div>
        </section>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <?= Html::button('ยกเลิก', ['class' => 'btn btn-warning btn-sm pull-right', 'id' => 'back-show-profile']) ?>
                        <?= Html::submitButton('Update', ['class' => 'btn btn-primary btn-sm pull-right marR10', 'id' => 'submit-editprofile']) ?>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
