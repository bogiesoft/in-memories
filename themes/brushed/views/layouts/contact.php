    ...
    <div class="row">
    	...
    	<div class="col-md-4 profile">
        	<div class="image-wrap">
                ...
                <img src="<?= Yii::$app->assetManager->getPublishedUrl('@BRUSHAsset') ?>/img/profile/profile-01.jpg" alt="John Doe">
            </div>
    	...
    	<div class="col-md-4 profile">
        	<div class="image-wrap">
                ...
                <img src="<?= Yii::$app->assetManager->getPublishedUrl('@BRUSHAsset') ?>/img/profile/profile-02.jpg" alt="Jane Helf">
            </div>
    	...
    	<div class="col-md-4 profile">
        	<div class="image-wrap">
                ...
                <img src="<?= Yii::$app->assetManager->getPublishedUrl('@BRUSHAsset') ?>/img/profile/profile-03.jpg" alt="Joshua Insanus">
            </div>
